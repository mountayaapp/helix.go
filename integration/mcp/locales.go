...
The catalog is shared with the REST and GraphQL integrations: a single call from
any package surfaces in every error path so the wire shape stays consistent
across transports.
...
Example:
	...
	mcp.AddOrEditLanguage(language.French, map[int]string{
